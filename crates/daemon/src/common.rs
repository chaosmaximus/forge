...
pub const STOP_WORDS: &[&str] = &[
    ...
    "don", "over", "causes", "caused", "prevents", "prevented", "subtle",
    "via", "since", "further", "including", "within", "among", "between",
    "needs", "needed", "because", "while", "already", "without", "again",
    "much", "many", "less", "enough", "rather", "though", "although",
